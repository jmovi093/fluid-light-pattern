...
export function useLightBlobs(maskCanvasRef, fluidCanvasRef, config, showDebug) {
    const [debugInfo, setDebugInfo] = useState({ spots: 0, fps: 0 });
    const lightSpotsRef = useRef([]);
    ...
    useEffect(() => {
        ...
        const addLightSpot = (x, y, opacity, velX, velY) => {
